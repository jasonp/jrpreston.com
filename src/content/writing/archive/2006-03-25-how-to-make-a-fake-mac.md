---
title: "How To: Make a fake Mac"
description: "Out of curiosity, I decided to see how close I could get my laptop to looking like a Mac. As usually happens when I set out to do something like this, I disc..."
pubDate: 2006-03-25
archive: true
tags: [archive]
---
...
-   [Volume Widget](http://widgets.yahoo.com/gallery/view.php?widget=38921)\*
  
-   [Mac backgound image](http://aqua-gero.com/index.php?ind=downloads&op=entry_view&iden=10)
  
-   [Mozilla Firefox](http://www.mozilla.com/firefox/)
  
-   [iFox Firefox theme](https://addons.mozilla.org/themes/moreinfo.php?id=1106&application=firefox)\*
...
Now go to the page for the iFox theme. Click the "install now" link, and allow the installation. Firefox will look like Safari the next time you open it. There's a guide to a more complete makeover found [here](http://www.aqua-soft.org/board/showthread.php?t=32106), but it looks like getting the final adjustments required having a program called [WindowsBlinds](http://www.stardock.com/products/windowblinds/downloads.asp). (This theme is slightly different from iFox, and it's what I used).
...
Download and install [FlyakiteOSX](http://osx.portraitofakite.com/). That's it.
