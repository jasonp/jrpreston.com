...
date: 2026-04-13
source_articles:
  - "The formlessness of AI agents" (David Hoang / Proof of Concept) — core frame of agents searching for the right "body" beyond chat
  - "Claude Cowork 101: How to automate your workday without touching code" (Claire Vo interviewing JJ Englert / Lenny's Newsletter) — concrete examples of agents embedded in real workflows
  - "Microsoft 365 Copilot and the end of the single-model era in enterprise AI" (GeekWire weekly roundup link) — signal that enterprise AI is moving toward many agents, many models
status: draft
---
...
In [David Hoang’s piece on the formlessness of AI agents](https://www.proofofconcept.pub/p/the-formlessness-of-ai-agents), he uses Ultron as the metaphor: same intelligence, new bodies. Each version is less about making the brain smarter and more about finding a better shell. That’s what’s happening with agents. The models are compounding, but the really hard question is, “What’s the right body for this intelligence?”

You can see early answers starting to show up. In [Lenny’s interview with JJ Englert](https://www.lennysnewsletter.com/p/claude-cowork-101-how-to-automate), Claude Cowork stops being a chat and starts being a project that lives in a folder on your computer. It reads your “brain” file, learns your preferences, connects to Gmail and Calendar, and quietly runs scheduled tasks. The interface is still text, but the *body* is closer to an operating system that’s paying attention while you live your day.

On the enterprise side, Microsoft is wiring multiple models into 365 Copilot so they can check each other’s work and specialize inside documents, email, and meetings. Buried in [GeekWire’s weekly roundup](https://www.geekwire.com/2026/geekwire-weekly-roundup-2026-04-05/) is a small but important idea: the single-model era is ending. We’re moving toward a mesh of agents, each with a different job, all inhabiting the tools people already use.
