...
date: 2026-04-10
source_articles:
  - "Poke is OpenClaw for normies, $136,000 for billionaires" (Alex Heath / Sources) — Poke as a proactive assistant with usage-based, value-sensitive pricing and a $136k/month outlier.
  - "Microsoft 365 Copilot and the end of the single-model era in enterprise AI" (GeekWire / Ken Yeung) — Multi-model Copilot, Researcher agent, and shifting judgment to AI ensembles.
  - "Opinion: How to read with AI" (GeekWire / Oren Etzioni) — Framework for AI as reading coach vs ghostwriter, and the risk of outsourcing thinking.
status: draft
---
...
Look at what’s happening at the other end of the spectrum. On the enterprise side, [Microsoft’s new Copilot Researcher](https://www.geekwire.com/2026/microsoft-365-copilot-and-the-end-of-the-single-model-era-in-enterprise-ai/) uses multiple models under the hood — GPT to draft, Claude to critique — so that “two AIs keep tabs on each other” before a memo hits your screen. Microsoft’s pitch to knowledge workers is simple: we’ll not only write the draft, we’ll also do the first-pass review you don’t have time for.

Meanwhile, Oren Etzioni is waving a caution flag in his piece on [how to read with AI](https://www.geekwire.com/2026/opinion-how-to-read-with-ai/). If you let AI summarize everything for you, your understanding gets flatter and your advice gets worse. The risk isn’t that AI reads for you. It’s that you quietly give up the habit of thinking for yourself.
