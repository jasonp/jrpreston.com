...
date: 2026-04-09
source_articles:
  - "How ‘Zombie Flow’ Took Over Culture" (Derek Thompson) — core framing of "zombie flow" vs. real flow and how tech feeds it
  - "Opinion: How to read with AI" (GeekWire) — practical ideas for using AI as a reading amplifier, not a replacement
  - "The Substack-ification of American Religion" (Derek Thompson) — example of fragmented, niche communities and identity feeds
status: draft
---
