---
title: "Why I use the premium Thesis Theme for WordPress"
description: "Disclaimer: I am a member of the Thesis affiliate program, which means that if you follow one of my linkshttp://diythemes.com?aaid=jp and buy Thesis, I will ..."
pubDate: 2008-09-03
archive: true
tags: [archive]
---

**Disclaimer**: I am a member of the Thesis affiliate program, which means that if you follow one of [my links](http://diythemes.com?a_aid=jp) and buy Thesis, I will love you forever (and make about $20). I'd like to think that my rave reviews are unaffected by this fact, but that's for you to decide.

[![Thesis WordPress Theme](http://diythemes.com/aff/scripts/sb.php?a_aid=jp&a_bid=47c5a620)](http://diythemes.com/thesis/?a_aid=jp&a_bid=47c5a620)As part of my work, I design, build, and configure custom WordPress installations for clients who are looking to start blogging. This means digging into PHP files and gutting CSS stylesheets so that I end up with just the right combination of colors, fonts, and images.
...
I think I actually cackled when I saw this for the first time. This is why Jason-Preston.com and [Eat Sleep Publish](http://eatsleeppublish.com) and [Web Community Forum](http://webcommunityforum.com) can all look so different while running the same theme.

Amazingly, this list includes choices such as [Calibri](http://en.wikipedia.org/wiki/Calibri) and [Constantia](http://en.wikipedia.org/wiki/Constantia_\(typeface\)), which you typography/web geeks well know are *not* on the short list of two or three fonts that are available in all browsers.
...
-   Choose between 26 fonts for your site
  
-   Individually select fonts and sizes for the Header, Titles, h3s, etc
  
-   Choose between 1, 2, and 3-column layouts
  
-   Choose the size of those columns
  
-   Customize the byline on your posts
  
-   Choose whether to display the media box in the sidebar or not
  
-   Choose whether to show images, video, or custom code in the media box
  
-   Pick which pages you want to appear in your top navigation bar
  
-   Link to custom URLs in the top navigation bar
  

Not only can you implement basic changes without getting into the code at all, using this theme essentially makes your site *future-proof*, because [Chris](http://pearsonified.com) is going to keep developing Thesis as changes continue to happen in WordPress and in search engine algorithms.
...
2.  The "edit" link for individual posts when you're logged in as the admin. I rely on this link *all the time* to edit posts on the fly when I see is poorly aligned image or a misspelled word. Frankly, this is pretty easy to add and I'm just lazy so I haven't yet.
  
4.  Individual CSS styling on page tabs isn't possible. The first version of Thesis let you do cool things to the navigation menu (like color one menu item green, or point one of them for a category page), and use custom CSS to make sure it all looked pretty. Can't do that anymore. Annoying as hell.
  
6.  Disappearing favicons - when I moved [Eat Sleep Publish](http://eatsleeppublish.com) to Thesis, I also lost my Favicon for a while, which happens because the metadata isn't pre-set up in the header.php file. Actually I think it probably broke because I did something weird to my favicon file - most browsers should find the file automatically nowadays.
...
Chris spends a lot of time writing up [beautiful explanations](http://diythemes.com/thesis/rtfm/) on how to use each feature in the theme. The explanations are well thought out, visual, and easy to follow.
...
So what are you waiting for? Go [buy it](http://diythemes.com?a_aid=jp) now.
